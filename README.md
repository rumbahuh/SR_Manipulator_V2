# SR_Manipulator_V2
Simulación de un rover manipulador en ROS 2 Jazzy con integración de MoveIt, Gazebo y RViz.
El proyecto incluye teleoperación, manipulación de objetos mediante brazo SCARA y análisis de datos registrados mediante rosbag.
...
```
## El registro de los datos se llevó a cabo con un rosbag
```
...
- [Metada YAML](https://github.com/rumbahuh/SR_Manipulator_V2/blob/main/rosbag_kachau/metadata.yaml)
## Captura de RVIZ
### Modelo TF aislado
...
### Cubo verde después de dejarlo sobre el tanque
...
### Rover después de recorrer los últimos metros
...
## Modelo del rover
Actualmente las texturas no se han integrado correctamente en la conversión desde Blender a URDF. El aspecto originales el siguiente:
![Nightwing vroom vroom](https://github.com/rumbahuh/SR_Manipulator_V2/blob/main/modelo/rover.png)
El tanque lo implementé de manera simple para poder simplificar el movimiento del SCARA a la hora de recoger y depositar los cubos.
